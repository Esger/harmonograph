...
if (isset($GLOBALS["HTTP_RAW_POST_DATA"]))
{
	...
	function mergeImageWithBackground () {
		...
		// Copy
		$final = alphaOverlay($dest, $src, 800, 600);
		imagecolormatch($src, $final);
		
		// Output and free from memory
		header('Content-Type: image/jpeg');
		imagejpeg($final, 'img/harmonogram-'.$_REQUEST[imageId].'.jpg',60);
...
<head>
	...
	<meta property="og:url" content="https://www.ashware.nl/harmonograph/snapshot.php?imageId='.$imageId.'" />
	<meta property="og:title" content="This is my creation... what\'s yours?"/>
	<meta property="og:image" content="https://www.ashware.nl/harmonograph/img/harmonogram-'.$imageId.'.jpg" />
	<meta property="og:description" content="Interactive Harmonograph - Create your own artwork!" />
	<link rel="image_src" href="https://www.ashware.nl/harmonograph/img/harmonogram-'.$imageId.'.jpg" />
...
<body>
	<h1><a href="https://www.ashware.nl/harmonograph">Create your own harmonogram here</a></h1>
	<img class="harmonogram" src="img/harmonogram-'.$imageId.'.jpg" alt="mijn harmonogram" />
	<div class="addThis">
		<!-- AddThis Button BEGIN -->
		<div class="addthis_toolbox addthis_default_style ">
			<a class="addthis_counter addthis_pill_style"></a>
		</div>
		<script type="text/javascript" src="https://s7.addthis.com/js/250/addthis_widget.js#pubid=ra-4f3c4b976815089f"></script>
		<!-- AddThis Button END -->
	</div>
